...
from .views import (issue_tracker_bugs, single_bug, delete_bug, create_or_edit_bug,
                    upvote_bug, downvote_bug, issue_tracker_content, single_content, upvote_content,
                    downvote_content, delete_content, create_or_edit_content)
...
urlpatterns = [
    ...
    url(r'^(?P<pk>\d+)/downvote/', downvote_content, name="downvote_content"),
